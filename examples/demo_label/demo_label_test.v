...
fn test_demo_label_qml_centers_the_original_text() {
	root := ui2.element_from_qml_model(demo_label_qml_source, DemoLabel{}, ui2.rect(0, 0, demo_label_width, demo_label_height)) or { panic(err) }
