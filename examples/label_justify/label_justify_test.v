...
fn test_label_justify_qml_preserves_alignment_and_clipping_frame() {
	root := ui2.element_from_qml_model(label_justify_qml_source, LabelJustifyDemo{}, ui2.rect(0, 0, label_justify_width, label_justify_height)) or { panic(err) }
